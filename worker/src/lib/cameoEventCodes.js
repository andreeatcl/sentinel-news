...
export function decodeEventCode(eventCode, eventRootCode) {
  return (
    EVENT_CODE_LABELS[eventCode] ||
    ROOT_CODE_LABELS[eventRootCode] ||
    `Type ${eventCode}`
  );
}

export function decodeEventRootCode(rootCode) {
  return ROOT_CODE_LABELS[rootCode] || `Type ${rootCode}`;
}
